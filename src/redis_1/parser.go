...
type multiBulkParser func(rd *bufio_1.Reader, n int64) (interface{}, error)
...
func readLine(rd *bufio_1.Reader) ([]byte, error) {
...
func readN(rdd *bufio_1.Reader, n int) ([]byte, error) {	
	b, err := rdd.ReadN(n)
	if err == bufio_1.ErrBufferFull {
		tmp := make([]byte, n)
		r := copy(tmp, b)
		b = tmp
...
func parseReq(rd *bufio_1.Reader) ([]string, error) {
...
func parseReply(rd *bufio_1.Reader, p multiBulkParser) (interface{}, error) {
	line, err := readLine(rd)
	if err != nil {
		return nil, err
	}
...
func parseSlice(rd *bufio_1.Reader, n int64) (interface{}, error) {
...
func parseStringSlice(rd *bufio_1.Reader, n int64) (interface{}, error) {
...
func parseBoolSlice(rd *bufio_1.Reader, n int64) (interface{}, error) {
	vals := make([]bool, 0, n)
	for i := int64(0); i < n; i++ {
		viface, err := parseReply(rd, nil)
		if err != nil {
...
func parseStringStringMap(rd *bufio_1.Reader, n int64) (interface{}, error) {
...
func parseZSlice(rd *bufio_1.Reader, n int64) (interface{}, error) {
	zz := make([]Z, n/2)
	for i := int64(0); i < n; i += 2 {
		z := &zz[i/2]
