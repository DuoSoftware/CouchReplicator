...
type Cmder interface {
	args() []string
	parseReply(*bufio_1.Reader) error
	setErr(error)
...
func (cmd *Cmd) parseReply(rd *bufio_1.Reader) error {
...
func (cmd *SliceCmd) parseReply(rd *bufio_1.Reader) error {
...
func (cmd *StatusCmd) parseReply(rd *bufio_1.Reader) error {
...
func (cmd *IntCmd) parseReply(rd *bufio_1.Reader) error {
	v, err := parseReply(rd, nil)
	if err != nil {
		cmd.err = err
		return err
...
func (cmd *DurationCmd) parseReply(rd *bufio_1.Reader) error {
	v, err := parseReply(rd, nil)
	if err != nil {
		cmd.err = err
		return err
...
func (cmd *BoolCmd) parseReply(rd *bufio_1.Reader) error {
	v, err := parseReply(rd, nil)
	if err != nil {
		cmd.err = err
		return err
...
func (cmd *StringCmd) parseReply(rd *bufio_1.Reader) error {
	v, err := parseReply(rd, nil)
	if err != nil {
		cmd.err = err
		return err
...
func (cmd *FloatCmd) parseReply(rd *bufio_1.Reader) error {
	v, err := parseReply(rd, nil)
	if err != nil {
		cmd.err = err
		return err
...
func (cmd *StringSliceCmd) parseReply(rd *bufio_1.Reader) error {
...
func (cmd *BoolSliceCmd) parseReply(rd *bufio_1.Reader) error {
...
func (cmd *StringStringMapCmd) parseReply(rd *bufio_1.Reader) error {
...
func (cmd *ZSliceCmd) parseReply(rd *bufio_1.Reader) error {
...
func (cmd *ScanCmd) parseReply(rd *bufio_1.Reader) error {
